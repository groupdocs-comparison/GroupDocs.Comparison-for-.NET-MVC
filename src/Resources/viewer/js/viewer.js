	...
	$('#gd-nav-search-next').on('click', function(e){
		...
		$('.gd-highlight').each(function(e){
			if(count == search_position){
				...
				if(search_position >= getComparisonSearchMatches()){
		...
		setSearchMatchCount(search_position, getComparisonSearchMatches());
	});
...
function highlightSearch(text) {
    ...
    if(text.length > 1){
		...
		var totalSearchMatches = getComparisonSearchMatches();
...
*/
function getComparisonSearchMatches(){
